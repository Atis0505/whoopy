...
> Frissítve: 2026-08 · Schema Whoopy **v16**
...
| Katalógus scale | `services/catalog.py` · pagination / index / sitemap · `docs/CATALOG_SCALE.md` |
...
| `docs/FEJLESZTESI_TERV.md` | Roadmap 1–21 |
| `docs/OMNIBUS_SUBSCRIPTIONS.md` | Ártörténet + ismétlődő rendelés |
| `docs/CATALOG_SCALE.md` | Pagination, indexek, sitemap chunk |

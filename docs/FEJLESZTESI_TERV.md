...
| 14 | **EU webshop csomag** | kész | GDPR, SEO, ÁFA, invoice, e-mail, track, contact, FAQ, filters, wishlist, returns, reviews + **jogi CMS sablonok** (`docs/EU_SHOP.md`, `docs/LEGAL.md`) |
...
| 18 | **Logisztika + Compliance** | kész | Futár/RMA stub, warehouse/partial fulfill, CMP, GDPR, B2B ÁFA, Omnibus alap (`docs/LOGISTICS_COMPLIANCE.md`) |
| 19 | **Storefront ops** | kész | Announcement, ticker, maintenance 1-gomb, kampány toggle, free-ship, badge, responsive (`docs/STOREFRONT_OPS.md`) |
